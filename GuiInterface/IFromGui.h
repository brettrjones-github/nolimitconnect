...
public:
	...
	virtual void				fromGuiSendAnnouncedList( EHostType hostType ) = 0;
	...
	virtual bool				fromGuiQueryUserListFromHosted( VxPtopUrl& hostedUrl, EHostType hostType, VxGUID& onlineIdIfNullThenAll ) = 0;
};
