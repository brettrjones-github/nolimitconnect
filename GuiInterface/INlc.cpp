...
//============================================================================
//============================================================================
void INlc::fromGuiKeyPressEvent( int moduleNum, int key, int mod )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiKeyReleaseEvent( int moduleNum, int key, int mod )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiMousePressEvent( int moduleNum, int mouseXPos, int mouseYPos, int mouseButton )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiMouseReleaseEvent( int moduleNum, int mouseXPos, int mouseYPos, int mouseButton )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiMouseMoveEvent( int moduleNum, int mouseXPos, int mouseYPos )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiResizeBegin( int moduleNum, int winWidth, int winHeight )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiResizeEvent( int moduleNum, int winWidth, int winHeight )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiResizeEnd( int moduleNum, int winWidth, int winHeight )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiCloseEvent( int moduleNum )
{
#if ENABLE_KODI
...
//============================================================================
void INlc::fromGuiVisibleEvent( int moduleNum, bool isVisible )
{
#if ENABLE_KODI
