...
// 122 ( 0x7A )                                                                                     
#define PKT_TYPE_HOST_OFFER_REQ		                ( PKT_TYPE_HOST_JOIN_REPLY + 1 )	            // 122 ( 0x7A )
#define PKT_TYPE_HOST_OFFER_REPLY					( PKT_TYPE_HOST_OFFER_REQ + 1 )	                // 123 ( 0x7B )
// 124 ( 0x7C )                                                                                     
#define PKT_TYPE_HOST_SEARCH_REQ		            ( PKT_TYPE_HOST_OFFER_REPLY + 1 )	            // 124 ( 0x7C )
#define PKT_TYPE_HOST_SEARCH_REPLY					( PKT_TYPE_HOST_SEARCH_REQ + 1 )	            // 125 ( 0x7D )
// 126 ( 0x7E )                                                                                     
#define PKT_TYPE_FRIEND_OFFER_REQ		            ( PKT_TYPE_HOST_SEARCH_REPLY + 1 )	            // 126 ( 0x7E )
#define PKT_TYPE_FRIEND_OFFER_REPLY					( PKT_TYPE_FRIEND_OFFER_REQ + 1 )	            // 127 ( 0x7F )
// 128 ( 0x80 )                                                                                     
#define PKT_TYPE_OFFER_SEND_REQ						( PKT_TYPE_FRIEND_OFFER_REPLY	+ 1 )			// 128 ( 0x80 )
#define PKT_TYPE_OFFER_SEND_REPLY					( PKT_TYPE_OFFER_SEND_REQ	+ 1 )			    // 129 ( 0x81 )
#define PKT_TYPE_OFFER_CHUNK_REQ					( PKT_TYPE_OFFER_SEND_REPLY	+ 1 )			    // 130 ( 0x82 )
#define PKT_TYPE_OFFER_CHUNK_REPLY					( PKT_TYPE_OFFER_CHUNK_REQ	+ 1 )			    // 132 ( 0x83 )
#define PKT_TYPE_OFFER_SEND_COMPLETE_REQ			( PKT_TYPE_OFFER_CHUNK_REPLY	+ 1 )		    // 132 ( 0x84 )
#define PKT_TYPE_OFFER_SEND_COMPLETE_REPLY			( PKT_TYPE_OFFER_SEND_COMPLETE_REQ + 1 )	    // 133 ( 0x85 )
#define PKT_TYPE_OFFER_XFER_ERR						( PKT_TYPE_OFFER_SEND_COMPLETE_REPLY + 1 )	    // 134 ( 0x86 )
// 135 ( 0x87 )                                                                                     
#define PKT_TYPE_WEB_SERVER_MY_PIC_SEND_REQ			( PKT_TYPE_OFFER_XFER_ERR	+ 1 )				// 135 ( 0x87 )
#define PKT_TYPE_WEB_SERVER_MY_PIC_SEND_REPLY		( PKT_TYPE_WEB_SERVER_MY_PIC_SEND_REQ	+ 1 )	// 136 ( 0x88 )
#define PKT_TYPE_WEB_SERVER_PIC_CHUNK_TX			( PKT_TYPE_WEB_SERVER_MY_PIC_SEND_REPLY	+ 1 )	// 137 ( 0x89 )
#define PKT_TYPE_WEB_SERVER_PIC_CHUNK_ACK			( PKT_TYPE_WEB_SERVER_PIC_CHUNK_TX	+ 1 )		// 138 ( 0x8A )
#define PKT_TYPE_WEB_SERVER_GET_CHUNK_TX			( PKT_TYPE_WEB_SERVER_PIC_CHUNK_ACK	+ 1 )       // 139 ( 0x8B )
#define PKT_TYPE_WEB_SERVER_GET_CHUNK_ACK			( PKT_TYPE_WEB_SERVER_GET_CHUNK_TX	+ 1 )       // 140 ( 0x8C )
#define PKT_TYPE_WEB_SERVER_PUT_CHUNK_TX			( PKT_TYPE_WEB_SERVER_GET_CHUNK_ACK	+ 1 )       // 141 ( 0x8D )
#define PKT_TYPE_WEB_SERVER_PUT_CHUNK_ACK			( PKT_TYPE_WEB_SERVER_PUT_CHUNK_TX	+ 1 )       // 142 ( 0x8E )
// 143 ( 0x8F )                                                                                     
...
// 145 ( 0x91 )                                                                                     
#define PKT_TYPE_RELAY_SERVICE_REQ					( PKT_TYPE_STORY_DATA_REPLY	+ 1 )				// 145 ( 0x91 )
#define PKT_TYPE_RELAY_SERVICE_REPLY				( PKT_TYPE_RELAY_SERVICE_REQ	+ 1 )			// 146 ( 0x92 )
#define PKT_TYPE_RELAY_CONNECT_REQ					( PKT_TYPE_RELAY_SERVICE_REPLY	+ 1 )			// 147 ( 0x93 )
#define PKT_TYPE_RELAY_CONNECT_REPLY				( PKT_TYPE_RELAY_CONNECT_REQ	+ 1 )			// 148 ( 0x94 )
#define PKT_TYPE_RELAY_SESSION_REQ					( PKT_TYPE_RELAY_CONNECT_REPLY	+ 1 )			// 149 ( 0x95 )
#define PKT_TYPE_RELAY_SESSION_REPLY				( PKT_TYPE_RELAY_SESSION_REQ	+ 1 )			// 150 ( 0x96 )
#define PKT_TYPE_RELAY_CONNECT_TO_USER_REQ			( PKT_TYPE_RELAY_SESSION_REPLY	+ 1 )			// 151 ( 0x97 )
#define PKT_TYPE_RELAY_CONNECT_TO_USER_REPLY		( PKT_TYPE_RELAY_CONNECT_TO_USER_REQ + 1 )      // 152 ( 0x98 )
...
// 162 ( 0xA2 )     
#define PKT_TYPE_HOST_INVITE_ANN_REQ				( PKT_TYPE_HOST_INFO_REPLY + 1 )		        // 162 ( 0xA2 )
#define PKT_TYPE_HOST_INVITE_ANN_REPLY			    ( PKT_TYPE_HOST_INVITE_ANN_REQ	+ 1 )           // 163 ( 0xA3 )
#define PKT_TYPE_HOST_INVITE_SEARCH_REQ				( PKT_TYPE_HOST_INVITE_ANN_REPLY + 1 )		    // 164 ( 0xA4 )
