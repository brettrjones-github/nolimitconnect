...
#define PKT_TYPE_FRIEND_OFFER_REPLY					( PKT_TYPE_FRIEND_OFFER_REQ + 1 )	        // 121 ( 0x79 )

#define PKT_TYPE_THUMB_SEND_REQ					    ( PKT_TYPE_FRIEND_OFFER_REPLY	+ 1 )		// 122 ( 0x7A )
#define PKT_TYPE_THUMB_SEND_REPLY				    ( PKT_TYPE_THUMB_SEND_REQ	+ 1 )			// 123 ( 0x7B )
#define PKT_TYPE_THUMB_CHUNK_REQ				    ( PKT_TYPE_THUMB_SEND_REPLY	+ 1 )			// 124 ( 0x7C )
#define PKT_TYPE_THUMB_CHUNK_REPLY				    ( PKT_TYPE_THUMB_CHUNK_REQ	+ 1 )			// 125 ( 0x7D )
#define PKT_TYPE_THUMB_SEND_COMPLETE_REQ		    ( PKT_TYPE_THUMB_CHUNK_REPLY	+ 1 )		// 126 ( 0x7E )
#define PKT_TYPE_THUMB_SEND_COMPLETE_REPLY		    ( PKT_TYPE_THUMB_SEND_COMPLETE_REQ + 1 )	// 127 ( 0x7F )
#define PKT_TYPE_THUMB_XFER_ERR					    ( PKT_TYPE_THUMB_SEND_COMPLETE_REPLY + 1 )	// 128 ( 0x80 )

#define PKT_TYPE_OFFER_SEND_REQ						( PKT_TYPE_THUMB_XFER_ERR	+ 1 )			// 129 ( 0x81 )
#define PKT_TYPE_OFFER_SEND_REPLY					( PKT_TYPE_OFFER_SEND_REQ	+ 1 )			// 130 ( 0x82 )
#define PKT_TYPE_OFFER_CHUNK_REQ					( PKT_TYPE_OFFER_SEND_REPLY	+ 1 )			// 131 ( 0x83 )
#define PKT_TYPE_OFFER_CHUNK_REPLY					( PKT_TYPE_OFFER_CHUNK_REQ	+ 1 )			// 132 ( 0x84 )
#define PKT_TYPE_OFFER_SEND_COMPLETE_REQ			( PKT_TYPE_OFFER_CHUNK_REPLY	+ 1 )		// 133 ( 0x85 )
#define PKT_TYPE_OFFER_SEND_COMPLETE_REPLY			( PKT_TYPE_OFFER_SEND_COMPLETE_REQ + 1 )	// 134 ( 0x86 )
#define PKT_TYPE_OFFER_XFER_ERR						( PKT_TYPE_OFFER_SEND_COMPLETE_REPLY + 1 )	// 135 ( 0x87 )
