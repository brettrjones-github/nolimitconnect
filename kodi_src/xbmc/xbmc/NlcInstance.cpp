...
//============================================================================
NlcInstance::NlcInstance( P2PEngine& engine )
: INlc( engine )
, m_IsCreated( false )
, m_bStop( false )
, m_AppFocused( true )
...
//============================================================================
bool NlcInstance::runNlc( void )
{
    return Run();
}

//============================================================================
int NlcInstance::toGuiPlayVideoFrame( VxGUID& onlineId, uint8_t * picBuf, uint32_t picBufLen, int picWidth, int picHeight )
{
    return m_Engine.getToGuiInterface().toGuiPlayVideoFrame( onlineId, picBuf, picBufLen, picWidth, picHeight );
}

//============================================================================
void NlcInstance::destroyNlc( void )
{
    if( m_IsCreated )
    {
        Destroy();
...
//============================================================================
bool NlcInstance::checkCreateNlc( void )
{
    if( !m_IsCreated )
    {
        m_IsCreated = true;
...
//============================================================================
void NlcInstance::FrameMove( bool processEvents, bool processGUI )
{

}

//============================================================================
void NlcInstance::Render( void )
{
}

//============================================================================
void NlcInstance::Process( void )
{
}
