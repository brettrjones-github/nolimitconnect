...
//============================================================================
RCODE HostListDb::onCreateTables( int iDbVersion )
{
...
//============================================================================
RCODE HostListDb::onDeleteTables( int iOldVersion )
{
...
//============================================================================
bool HostListDb::saveHostEntry( EHostType hostType, std::string hostUrl, VxGUID& onlineId, int64_t timestamp )
{
	/*
	RCODE rc = 0;
	...
	{
		LogMsg( LOG_ERROR, "HostListDb::handleAnnounce: invalid anchorListIn count\n" );
		return -2;
	}
	...
	if( rc )
	{
		LogMsg( LOG_ERROR, "HostListDb::handleAnnounce: ERROR %d updating user\n", rc );
	}
	...
	if( NULL != cursor )
	{
		...
		while( cursor->getNextRow() )
		{
			if( bShouldListRowToClient )
			{
				...
				{
					LogMsg( LOG_ERROR, "HostListDb::handleAnnounce: invalid blob len %d\n", blobLen );
				}
				else
				{
	...
	if( MAX_ANN_MATCH_ENTRIES == foundEntryIdx )
	{
		...
		if( rc )
        {
			LogMsg( LOG_INFO, "Error %d limiting HostListDb\n", rc );
		}
	}
...
//============================================================================
bool HostListDb::validateId( std::string& onlineId )
{
	return true;
}

//============================================================================
bool HostListDb::validatePort( std::string& port )
{
	return true;
}
//============================================================================
bool HostListDb::validateIPv4( std::string& ipv4 )
{
	return true;
}
//============================================================================
bool HostListDb::validateIPv6( std::string& ipv6 )
{
	return true;
}
