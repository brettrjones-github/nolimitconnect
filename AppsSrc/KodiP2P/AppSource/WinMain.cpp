...
#if !defined( BUILD_KODIP2P_APP ) && !defined( BUILD_KODIQT_APP ) && !defined( BUILD_NLC_APP ) 
echo you must define BUILD_KODI_APP 1 in NlcAppConfig.h to build KodiP2P
echo you must define BUILD_NLC_APP 0 in NlcAppConfig.h to build KodiP2P
