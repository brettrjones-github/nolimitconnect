...
#include "ui_AppletRandomConnectJoin.h"

class AppletRandomConnectJoin : public AppletClientBase, public GuiHostedListCallback
{
	Q_OBJECT
public:
...
protected slots:
    ...
    void                        slotJoinDefaultRandomConnect( void );
