    ...
    : AppletSettingsHostBase( OBJNAME_APPLET_HOST_GROUP_STATUS, app, parent )
{
    ...
    getPluginSettingsWidget()->setupSettingsWidget( eAppletHostGroupStatus, ePluginTypeHostGroup );
...
//============================================================================
void AppletHostGroupStatus::savePluginSetting()
{
...
//============================================================================
void AppletHostGroupStatus::slotApplyServiceSettings()
{
    saveUiToSetting();
    m_MyApp.getEngine().getPluginSettingMgr().setPluginSetting( m_PluginSetting );
