...
public:
    ...
    AudioTestGenerator *        getAudio400HzGenerator()    { return m_AudioGen400Hz; }
    AudioTestGenerator *        getAudio100HzGenerator()    { return m_AudioGen100Hz; }
...
private:
    ...
    AudioTestGenerator *        m_AudioGen400Hz = nullptr;
    AudioTestGenerator *        m_AudioGen100Hz = nullptr;
