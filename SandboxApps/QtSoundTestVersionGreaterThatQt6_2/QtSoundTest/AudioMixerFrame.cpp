...
//============================================================================
int AudioMixerFrame::readMixerFrame( char* readBuf, bool speakerMuted, int samplesDesired, int upMultiply, int16_t prevSamp, int16_t& retPrevSamp )
{
	...
	if( samplesToRead )
	{
		...
		{
			retPrevSamp = 0;
			memset( readBuf, 0, samplesToRead * upMultiply );
		}
		else
		{
			if( 1 == upMultiply )
